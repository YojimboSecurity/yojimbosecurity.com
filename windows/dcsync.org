...
** Description
DCSync works by requesting account password data from a Domain Controller[fn:1]. It can also ask Domain Controllers to replicate information using the Directory 
Replication Service Remote Protocol[fn:2]. All this can be done without running any code on a Domain Controller unlike some of the other ways Mimikatz extracts 
...
*** Local
To run DCSync locally I will use Invoke-Mimikatz[fn:3].
...
*** Remote
To run DCSync remotely I will use secretsdump.py from Impacket[fn:5].
...
- Network Monitoring[fn:1]
  - DsGeNCChange

- Event ID [fn:6] [fn:7] [fn:8] [fn:9]
  - 4462
...
Footnotes
[fn:1] Ad security: Mimikatz DCSync Usage, Exploitation, and Detection

[fn:2] Extracting User Password Data with Mimikatz DCSync

[fn:3] Invoke-mimikatz

[fn:4] harnj0y: mimikatz-and-dcsync-and-extrasids-oh-my

[fn:5] security auditing being turned off

[fn:6] gentilkiwi splunk

[fn:7] ultimatewindowssecurity

[fn:8] ultimatewindowssecurity2

[fn:9] modern-active-directory-attack-scenarios-and-how-to-detect-them

[fn:10] domain controler audit policy keeps getting turned off
